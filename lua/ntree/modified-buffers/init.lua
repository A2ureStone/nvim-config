...
local items = require("ntree.modified-buffers.lib.items")
...
local M = {
  ...
  display_name = " 󰈚 modified-Buffers ",
}
...
M.setup = function(config, global_config)
  require("neo-tree.utils").register_stat_provider("modified-buffers", M.get_node_stat)
